...
Ad_week = df |> mutate(week = as.numeric(week)) |> 
  glmmTMB(cbind(7-Ad,Ad) ~  treatment + period + week, family = binomial, data = _)
...
### exclude week
Ad_noweek = df |> glmmTMB(cbind(7-Ad,Ad) ~  treatment + period, family = binomial, data = _)
...
### exclude week
Ad_noweek = df |> glmmTMB(cbind(7-Ad,Ad) ~  treatment + period,  ziformula = ~1, family = binomial, data = _)
