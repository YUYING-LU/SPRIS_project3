...
1) Had to fit glmer instead of lmer for AE. Also, does the Wilcoxon rank test even work for binary? Would the McNemar test work/be appropriate?
...
7) Penalized logistic regression?
